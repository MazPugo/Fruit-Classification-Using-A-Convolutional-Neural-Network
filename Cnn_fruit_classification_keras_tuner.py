...
#best networks -hyperparameters
tuner.get_best_hyperparameters()[0].values

#summary of best network architecture
#make the prediction using the network
...
num_epochs = 50
model_filename = r'C:\Users\litch\Desktop\DATA_SCIENCE_INFINITY\DeepLearning\CNN\models\fruits_cnn_tuned.h5'
